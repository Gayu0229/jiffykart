...
public class SellerApplicationService {
    ...
    public void approveApplication(Long applicationId) {
        ...
        Shop shop = Shop.builder()
                ...
                .businessModel(application.getBusinessModel())
                .foodBusinessType(application.getFoodBusinessType())
                .restaurantName(application.getRestaurantName())
                .deliveryRadius(application.getDeliveryRadius())
                .restaurantCapacity(application.getRestaurantCapacity())
                .indoorSeats(application.getIndoorSeats())
                .outdoorSeats(application.getOutdoorSeats())
                .reservationEnabled(application.isReservationEnabled())
                .kitchenType(application.getKitchenType())
                .vegNonVeg(application.getVegNonVeg())
                .restaurantCategory(application.getRestaurantCategory())
                .diningType(application.getDiningType())
                .parkingAvailable(application.isParkingAvailable())
